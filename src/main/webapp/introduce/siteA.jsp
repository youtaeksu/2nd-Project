...
<jsp:include page="../layout/header.jsp"></jsp:include>
      ...
      <article class="imggroup">
				<div class="imgview marginBottom20"><img src="./사이트A_files/siteb.jpg" class="imgview100"></div>
				<div class="imgview"><img src="./사이트A_files/siteb_1.jpg" class="imgview100"></div>
	  </article>
